...
import { SearchCategoryProps } from '../../types/types'
import { getFrecCategories } from "./hooks/fetchCategories";

const Categories = memo(({ searchCategory, setSearchCategory }: SearchCategoryProps) => {
  const scrollContainerRef = useRef<HTMLDivElement>(null);
  const categories = getFrecCategories()
